...
public class ViewGroups extends javax.swing.JFrame {
 ...
 private User user = CurrentUser.getInstance().getCurrentUser();
 private GroupManager manager=new GroupManager();
    ...
    public ViewGroups() {
        initComponents();
         JFrame frame = new JFrame("Group List Example");
    ...
    private void openActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_openActionPerformed
       ...
       return;}
         ...
         JFrame window =factory.createWindow(user,selectedGroup);
